"""
Secondary WS Service – Monitors PRIMARY (port 1433)
Install : python ws_secondary.py install
Start   : net start SCADASecondaryWS
Stop    : net stop SCADASecondaryWS
Remove  : python ws_secondary.py remove
"""
...
MONITORED_SERVER_NAME = 'PRIMARY'
MY_SERVER_NAME = 'SECONDARY'
CHECK_INTERVAL = 30
DEBOUNCE_THRESHOLD = 1

LOG_DIR = r'C:\ScadaLogs'
LOG_FILE = os.path.join(LOG_DIR, 'secondary_logs.log')
...
# ================== WINDOWS SERVICE ==================
class SecondaryService(win32serviceutil.ServiceFramework):
    _svc_name_ = 'SCADASecondaryWS'
    _svc_display_name_ = 'SCADA Secondary WS'

    def __init__(self, args):
        win32serviceutil.ServiceFramework.__init__(self, args)
        self.hWaitStop = win32event.CreateEvent(None, 0, 0, None)
        self.monitor = SecondaryMonitor()
        self.thread = None
...
if __name__ == '__main__':
    if len(sys.argv) == 1:
        ...
        win32serviceutil.HandleCommandLine(SecondaryService)
